          ...
          return (
            <>
              ...
              <OpenSource
                repos={REPOS}
                accent={ACCENT}
                caption='The Microlink embed API and SDK are powered by battle-tested open source libraries used by thousands of developers worldwide. Read the source, fork it, ship a PR.'
              />
              <Playground />
              <Features
